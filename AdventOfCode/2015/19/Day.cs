...
public static class Day19
{
	...
	{
		var lines = File.ReadAllLines("AdventOfCode/2015/19/Input.txt");

		var replacements = lines.SkipLast(2).Select(r => r.Split(" => ")).Select(r => (From: r[0], To: r[1]));
