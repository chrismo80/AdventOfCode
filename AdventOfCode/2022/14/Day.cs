...
public static class Day14
{
    ...
    {
        var input = File.ReadAllLines("AdventOfCode/2022/14/Input.txt").Append("300,173 -> 700,173")
    ...
    static void PrintMap(HashSet<(int X, int Y)> walls, HashSet<(int X, int Y)> sand)
    {
        ...
        File.WriteAllLines("AdventOfCode/2022/14/Output.txt", output);
    }
}